    ...
    return ( 
        <div className="product__card__card">
            <div className="product__card">
                ...
                > 
                    {isHovered? <img src={`${API_URL}/public/${props.item.category}/${props.item.image[1].filename}`} alt="item" className="product__img"/>: <img src= {`${API_URL}/public/${props.item.category}/${props.item.image[0].filename}`} alt="item" className="product__img"/> }
                </div>
